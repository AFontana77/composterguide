  ...
  return (
    ...
    >
      <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-primary">
        Editor&apos;s pick &middot; Best {props.winnerCategory}
      </p>
      <h2 className="mb-4 text-2xl md:text-3xl font-heading font-bold leading-tight text-foreground">
        {props.winnerName}
      </h2>
      ...
      <a
        ...
        target="_blank"
        className="inline-flex w-full items-center justify-center rounded-xl bg-accent px-6 py-4 text-base md:text-lg font-bold text-accent-foreground shadow-sm transition hover:bg-accent/90 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 min-h-[48px]"
      >
